...
var base = Rebase.createClass({
  apiKey: "AIzaSyCP57aog3VGTJClREPz_uK0inmHy1JwJ8I",   // replace with your Firebase application's API key
  databaseURL: "https://final-9c5e5.firebaseio.com/ ", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    var sortmovies = this.state.movies
    if (view==='alpha') {
      sortmovies = movieData.sort(this.movieCompareByTitle)
    } else if (view==='latest') {
  sortmovies = movieData.sort(this.movieCompareByReleased)
